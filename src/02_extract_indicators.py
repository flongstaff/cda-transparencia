...
def extract_indicators_from_caif():
    ...
    try:
        ...
        print(f"✅ Loaded CAIF data with {len(df)} rows")
        ...
        print(f"✅ Extracted {len(records)} indicators from CAIF data")
        return records
    
    except Exception as e:
        print(f"❌ Error extracting indicators from CAIF: {e}")
        return []
...
def extract_indicators_from_budget_data():
    ...
    try:
        ...
        for file_path in budget_files:
            ...
            print(f"✅ Processing budget data for year {year}")
        ...
        print(f"✅ Extracted {len(records)} budget indicators")
        return records
    
    except Exception as e:
        print(f"❌ Error extracting budget indicators: {e}")
        return []

def main():
    """Main function to extract all indicators"""
    print("📊 Starting indicator extraction...")
    ...
    if all_indicators:
        ...
        print(f"💾 Saved indicators to {json_output_path}")
        ...
        print("❌ No indicators were extracted")
