    ...
    async getDocumentById(id) {
        try {
            ...
            return {
                ...
                size_mb: (doc.size_bytes / (1024 * 1024)).toFixed(2),
                url: doc.url,
                official_url: doc.official_url || `https://carmendeareco.gob.ar/transparencia/wp-content/uploads/${doc.year}/${doc.month}/${doc.filename}`,
                archive_url: `web.archive.org/web/20220928084222/https://www.carmendeareco.gob.ar/transparencia/wp-content/uploads/${doc.year}/${doc.month}/${doc.filename}`,
                verification_status: doc.verification_status,
                processing_date: doc.created_at,
                data_sources: ['official_site'],
                file_size: (doc.size_bytes / (1024 * 1024)).toFixed(2),
