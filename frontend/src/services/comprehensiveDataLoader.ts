// comprehensiveDataLoader.ts - Central data loader that handles all data sources
import { 
...
class ComprehensiveDataLoader {
  private static instance: ComprehensiveDataLoader;
  ...
  public static getInstance(): ComprehensiveDataLoader {
    if (!ComprehensiveDataLoader.instance) {
      ComprehensiveDataLoader.instance = new ComprehensiveDataLoader();
    }
    return ComprehensiveDataLoader.instance;
  }

  /**
   * Load comprehensive data from all available sources
   */
  public async loadComprehensiveData(): Promise<ComprehensiveData> {
   ...
   */
  public async getDataForYear(year: number): Promise<ComprehensiveData> {
  ...
  private logAuditEvent(eventType: string, details: any): void {
    const auditEvent: AuditEvent = {
      ...
      source: 'ComprehensiveDataLoader',
      details,
      user_id: 'system'
    };
...
export const comprehensiveDataLoader = ComprehensiveDataLoader.getInstance();
export default comprehensiveDataLoader;