  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white p-6 rounded-lg">
        <h1 className="text-3xl font-bold">Licitaciones Públicas - Carmen de Areco</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Total Licitaciones</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold">{formatCurrencyARS(summary.total_amount)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold">{summary.year}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Estados Activos</p>
              <p className="text-2xl font-bold">{summary.active_statuses.length}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-6">
          {licitaciones && licitaciones.length > 0 ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="mt-2">No hay licitaciones disponibles</p>
            </div>
          )}
        </div>
      </div>
              ...
              {summary.active_statuses.map((status, index) => (
                <div key={index} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium">{status || 'Sin estado'}</span>
                  </div>
                </div>
              ))}
            </div>
