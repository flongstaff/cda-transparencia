...
import { unifiedDataIntegrationService } from '../../services/unifiedDataIntegrationService';
import { getMoneyFlowData, getContractData, ContractData } from '../../services/financialDataService';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const [moneyFlow, contractData] = await Promise.all([
          getMoneyFlowData(),
          getContractData()
        ]);
