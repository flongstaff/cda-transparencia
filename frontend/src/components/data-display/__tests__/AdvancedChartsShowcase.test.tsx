...
vi.mock('../index', () => ({
  TreemapChart: (props: Record<string, unknown>) => <div data-testid="treemap-chart">{JSON.stringify(props)}</div>,
  WaterfallChart: (props: Record<string, unknown>) => <div data-testid="waterfall-chart">{JSON.stringify(props)}</div>,
  FunnelChart: (props: Record<string, unknown>) => <div data-testid="funnel-chart">{JSON.stringify(props)}</div>,
  SankeyDiagram: (props: Record<string, unknown>) => <div data-testid="sankey-diagram">{JSON.stringify(props)}</div>,
  GanttChart: (props: Record<string, unknown>) => <div data-testid="gantt-chart">{JSON.stringify(props)}</div>,
  HeatmapCalendar: (props: Record<string, unknown>) => <div data-testid="heatmap-calendar">{JSON.stringify(props)}</div>,
  RadarChart: (props: Record<string, unknown>) => <div data-testid="radar-chart">{JSON.stringify(props)}</div>,
}));
