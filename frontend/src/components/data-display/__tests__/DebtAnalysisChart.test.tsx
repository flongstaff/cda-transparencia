...
describe('DebtAnalysisChart', () => {
  ...
  describe('Internationalization', () => {
    it('displays content in English when locale is changed', async () => {
      ...
      render(
        <DebtAnalysisChart year={2024} locale="en" />,
        { wrapper: createWrapper() }
      );
    ...
    it('formats currency according to locale', async () => {
      ...
      render(
        <DebtAnalysisChart year={2024} locale="es" />,
        { wrapper: createWrapper() }
      );
  ...
  describe('Performance', () => {
    it('memoizes expensive calculations', async () => {
      ...
      rerender(<DebtAnalysisChart year={2024} />);
    ...
    it('handles year prop changes efficiently', async () => {
      ...
      // Change year prop
      rerender(<DebtAnalysisChart year={2023} />);
