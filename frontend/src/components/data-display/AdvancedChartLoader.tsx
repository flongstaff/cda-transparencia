...
const DebtAnalysisChart = lazy(() => import('../charts/DebtAnalysisChart'));
const BudgetAnalysisChartEnhanced = lazy(() => import('../charts/BudgetAnalysisChartEnhanced'));
...
export const preloadAdvancedChart = async (chartType: AdvancedChartType): Promise<ComponentType<any>> => {
  switch (chartType) {
    case 'treemap':
      return (await import('../charts/TreemapChart')).default;
    case 'waterfall':
      return (await import('../charts/WaterfallChart')).default;
    case 'funnel':
      return (await import('../charts/FunnelChart')).default;
    case 'sankey':
      return (await import('./SankeyDiagram')).default;
    case 'debt':
      return (await import('../charts/DebtAnalysisChart')).default;
    case 'budget':
      return (await import('../charts/BudgetAnalysisChartEnhanced')).default;
    default:
