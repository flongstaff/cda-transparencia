...
import { Search, Filter, Download, Calendar, FileText, BarChart3, Eye, DollarSign, TrendingUp, Coins, Users, CreditCard, PieChart, Table, AlertTriangle, Scale, PiggyBank } from 'lucide-react';
...
interface UnifiedFinancialDashboardProps {
  ...
  viewMode: 'overview' | 'documents' | 'data' | 'charts' | 'debt' | 'employees' | 'performance' | 'analytics' | 'statistics';
  setViewMode: (mode: 'overview' | 'documents' | 'data' | 'charts' | 'debt' | 'employees' | 'performance' | 'analytics' | 'statistics') => void;
  category: string;
  title: string;
  icon: string;
}

const UnifiedFinancialDashboard: React.FC<UnifiedFinancialDashboardProps> = ({ 
  categoryData, 
  selectedYear, 
  searchTerm, 
  setSearchTerm, 
