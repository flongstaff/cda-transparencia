  ...
  if (!document.url) {
    return (
      <div className={`bg-gray-50 dark:bg-dark-background border-2 border-dashed border-gray-300 rounded-lg p-8 text-center ${className}`}>
        <FileImage className="w-16 h-16 text-gray-400 dark:text-dark-text-tertiary dark:text-dark-text-tertiary mx-auto mb-4" />
        <p className="text-gray-500 dark:text-dark-text-tertiary dark:text-dark-text-tertiary">No se proporcionó URL de la imagen</p>
      </div>
    );
  }
        ...
        {loading && (
          <div className="absolute inset-0 flex items-center justify-center bg-gray-50 dark:bg-dark-background dark:bg-dark-background">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-dark-text-secondary dark:text-dark-text-secondary">Cargando imagen...</p>
            </div>
          </div>
        )}
