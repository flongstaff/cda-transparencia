  ...
  return (
    <div className="dashboard">
      ...
      <div className="dashboard-content space-y-8">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Transparency Dashboard - {selectedYear}</h2>
        ...
        {metrics && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            ...
            {metrics.metrics && (
              <div className="mt-6">
                <h4 className="font-semibold text-gray-700 dark:text-gray-300 mb-3">Métricas Detalladas</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded text-center">
                    <p className="text-sm text-gray-600 dark:text-gray-400">Disponibilidad de Documentos</p>
                    <p className="text-xl font-bold text-gray-800 dark:text-white">
                      {metrics.metrics.document_availability}%
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded text-center">
                    <p className="text-sm text-gray-600 dark:text-gray-400">Divulgación Financiera</p>
                    <p className="text-xl font-bold text-gray-800 dark:text-white">
                      {metrics.metrics.financial_disclosure}%
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded text-center">
                    <p className="text-sm text-gray-600 dark:text-gray-400">Cumplimiento Legal</p>
                    <p className="text-xl font-bold text-gray-800 dark:text-white">
        ...
        {budget && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div className="overflow-x-auto">
              <pre className="bg-gray-100 dark:bg-gray-700 p-4 rounded text-sm overflow-auto max-h-60">
