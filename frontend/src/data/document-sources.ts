...
export const documentSources: DocumentSource[] = [
  // Budget Execution Documents
  {
    ...
    sources: {
      local: '../../../data/pdfs/2023/Estado-de-Ejecucion-de-Gastos-3er-Trimestres.pdf',
      web_archive: [
        '../../../data/pdfs/web_archives/web_archive/carmendeareco.gob.ar_transparencia/snapshot_20241111014916/',
        '../../../data/pdfs/web_archives/web_archive/carmendeareco.gob.ar_transparencia/snapshot_20241212115813/'
      ],
      official_website: 'https://carmendeareco.gob.ar/transparencia/',
      backup_locations: [
        '../../../data/pdfs/financial_data/',
        '../../../data/pdfs/general/'
      ]
    },
    verified: true,
  ...
  },
  {
    ...
    sources: {
      local: '../../../data/pdfs/2025/LICITACION-PUBLICA-N°10.pdf',
      web_archive: [
        '../../../data/pdfs/web_archives/web_archive/carmendeareco.gob.ar_transparencia/snapshot_20241111014916/'
      ],
      official_website: 'https://carmendeareco.gob.ar/transparencia/',
  ...
  },
  {
    ...
    sources: {
      local: '../../../data/pdfs/2024/ORDENANZA-3200-24-PRESUPUESTO-2024.pdf',
      official_website: 'https://carmendeareco.gob.ar/transparencia/',
      backup_locations: [
        '../../../data/pdfs/financial_data/'
      ]
  ...
  },
  {
    ...
    sources: {
      local: '../../../data/pdfs/2023/MODULO-FISCAL.xlsx',
      web_archive: [
        '../../../data/pdfs/web_archives/web_archive/carmendeareco.gob.ar_transparencia/snapshot_20241111014916/'
      ],
      official_website: 'https://carmendeareco.gob.ar/transparencia/'
...
export const webArchiveSnapshots = {
  carmendeareco_transparencia: [
    {
      ...
      path: '../../../data/pdfs/web_archives/web_archive/carmendeareco.gob.ar_transparencia/snapshot_20241111014916/',
      documents: 89,
      size: '2.1GB',
      verified: true
    },
    {
      ...
      path: '../../../data/pdfs/web_archives/web_archive/carmendeareco.gob.ar_transparencia/snapshot_20241212115813/',
      documents: 7,
      size: '156MB',
      verified: true,
  ...
  alternative_archive: [
    {
      date: '2024-11-11T01:49:16Z',
      path: '../../../data/pdfs/web_archives/web_archive_carmendeareco/snapshot_20241111014916/',
      documents: 36,
      size: '890MB',
      verified: true,
      type: 'partial_mirror'
