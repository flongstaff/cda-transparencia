...
import { AlertTriangle, DollarSign, Clock, TrendingUp, Building, Users, FileText } from 'lucide-react';
import { motion } from 'framer-motion';
import PowerBIEmbed from '../components/data-display/PowerBIEmbed';
...
const FinancialAuditDashboard: React.FC = () => {
  ...
  const getSeverityColor = (severity: _string): _string => {
    switch (severity) {
