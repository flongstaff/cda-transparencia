...
const getQuickLinks = (data: Record<string, unknown>) => [
  ...
  },
  {
    ...
    stats: `${data.categories?.length || 0} categorías disponibles`
  }
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            <div className="lg:w-2/3 mb-8 lg:mb-0">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  ...
                  Explorar Documentos ({transparencyData.totalDocuments})
                </Link>
              </div>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Datos Integrados y Procesados</h2>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="border border-gray-200 rounded-2xl p-6 bg-gradient-to-br from-blue-50 to-blue-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4">
              <div className="p-3 bg-blue-100 rounded-lg mr-4">
                <BarChart3 className="w-6 h-6 text-blue-600" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900">Análisis Financiero</h3>
                <p className="text-sm text-blue-700">Datos extraídos de PDFs</p>
              </div>
            </div>
            <p className="text-gray-700 mb-4">
              Visualización completa de indicadores financieros con datos reales extraídos
              de documentos oficiales y organizados en formatos accesibles.
            </p>
            <div className="space-y-2 mb-4">
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Archivos CSV generados:</span>
                <span className="font-semibold">{transparencyData.totalExpenses}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Registros de datos:</span>
                <span className="font-semibold">{transparencyData.totalRevenue.toLocaleString()}</span>
              </div>
            </div>
            <Link
              to="/budget"
          ...
          <div className="border border-gray-200 rounded-2xl p-6 bg-gradient-to-br from-green-50 to-green-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4">
              <div className="p-3 bg-green-100 rounded-lg mr-4">
                <PieChart className="w-6 h-6 text-green-600" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900">Distribución por Categorías</h3>
                <p className="text-sm text-green-700">Organización inteligente</p>
              </div>
            </div>
            <p className="text-gray-700 mb-4">
              Todos los documentos están organizados automáticamente por categorías:
              presupuesto, contratos, estados financieros y reportes estadísticos.
            </p>
            <div className="space-y-2 mb-4">
              {transparencyData.categories.slice(0, 3).map((category, index) => (
          ...
          <div className="border border-gray-200 rounded-2xl p-6 bg-gradient-to-br from-purple-50 to-purple-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4">
              <div className="p-3 bg-purple-100 rounded-lg mr-4">
                <LineChart className="w-6 h-6 text-purple-600" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900">Acceso Web Completo</h3>
                <p className="text-sm text-purple-700">API y descargas</p>
              </div>
            </div>
            <p className="text-gray-700 mb-4">
              Sistema completo con API endpoints, archivos CSV descargables y
              acceso directo a todos los documentos organizados.
            </p>
            <div className="space-y-2 mb-4">
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">API endpoints:</span>
                <span className="font-semibold">5+ activos</span>
              </div>
              <div className="flex justify-between text-sm">
