...
const CorruptionMonitoringDashboardWithErrorBoundary: React.FC = () => {
  return (
    <ErrorBoundary
      fallback={(error) => (
    ...
    >
      <CorruptionMonitoringDashboard />
    </ErrorBoundary>
  );
};

export default CorruptionMonitoringDashboardWithErrorBoundary;
