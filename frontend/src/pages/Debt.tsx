...
const DebtUnified: React.FC = () => {
  ...
  // Use debt data from current year
  const debtData = currentDebt;
          ...
          <div className="space-y-4">
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-900">Conjunto de datos consolidados de deuda</p>
                  <p className="text-sm text-gray-500">json • Finanzas municipales</p>
                </div>
              </div>
              <div className="flex items-center justify-between mt-2">
                ...
                <span className="text-xs text-gray-500">data/consolidated/{selectedYear}/debt.json</span>
              </div>
            </div>
            ...
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-900">Reportes de deuda histórica</p>
                  <p className="text-sm text-gray-500">csv • Análisis financiero</p>
                </div>
              </div>
              <div className="flex items-center justify-between mt-2">
                <span className="px-2 py-1 text-xs font-medium bg-green-100 text-green-600 rounded-full">
                ...
                <span className="text-xs text-gray-500">data/processed/csv/Debt_Report_2025_table_0.csv</span>
              </div>
            </div>
            ...
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-900">Documentos PDF oficiales</p>
                  <p className="text-sm text-gray-500">pdf • Transparencia activa</p>
                </div>
              </div>
              <div className="flex items-center justify-between mt-2">
                <span className="px-2 py-1 text-xs font-medium bg-green-100 text-green-600 rounded-full">
                ...
                <span className="text-xs text-gray-500">data/organized_pdfs/debt_reports/</span>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <>
      ...
      {/* Documents and Datasets Section - Always show to maintain page structure */}
      <div className="mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <ErrorBoundary>
          <UnifiedDataViewer
            title="Datos Abiertos de Deuda"
            description="Conjuntos de datos estructurados relacionados con la deuda municipal y documentos oficiales"
            category="debt"
            theme={['econ', 'debt', 'municipal']}
            year={selectedYear}
            showSearch={true}
            defaultTab="all"
            maxPDFs={12}
