...
const Salaries: React.FC = () => {
  ...
  useEffect(() => {
    loadSalaryDataForYear(activeYear);
  }, [activeYear]);
  ...
  const transformedSalaries = salaries.map((salary, index) => ({
    ...
    realValue2018: Math.round(salary.basic_salary / 10),
    inflationImpact: '-65.2',
    adjustmentCount: 2
  }));
  ...
  const aggregatedData = {
    ...
    purchasingPowerAnalysis: {
      ...
      inflationRate: 117.8,
      cumulativeInflation: 4353.9,
      realSalaryChange: -65.2,
      adjustmentsCount: 3,
    ...
    inflationData: { annual: 117.8, cumulative: 4353.9 }
  };
  ...
  const filteredSalaries = transformedSalaries.filter((salary) => {
    ...
    const matchesFilter = activeFilter === 'all' || salary.category === activeFilter;
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="mt-4 md:mt-0 flex flex-wrap gap-3">
              ...
              >
                ...
                <option value="political">Funcionarios Políticos</option>
                <option value="management">Personal Jerárquico</option>
                <option value="administrative">Personal Administrativo</option>
                <option value="services">Personal de Servicios</option>
                <option value="health">Personal de Salud</option>
                <option value="education">Personal Docente</option>
              </select>
            </div>
          </div>
        </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead className="bg-gray-50 dark:bg-gray-700">
                    <tr>
                      ...
                      <th className="text-left py-3 px-4 font-medium text-gray-600 dark:text-gray-400">Cargo</th>
