  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">Discrepancias Menores</p>
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">Discrepancias Mayores</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Ver</label>
          <select
            value={viewMode}
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Valor Local</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Valor Externo</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredData.map((audit) => (
                  <tr 
                    key={audit.id} 
                    className={`${audit.id % 2 === 0 ? 'bg-white' : 'bg-gray-50'} ${
                      Math.abs(audit.variancePercent) > 10 ? 'bg-red-50' : 
                      Math.abs(audit.variancePercent) > 5 ? 'bg-yellow-50' : ''
                    }`}
                  >
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{audit.category}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{audit.year}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{audit.type}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{formatCurrency(audit.localValue)}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{formatCurrency(audit.externalValue)}</td>
        ...
        <div className="bg-white rounded-lg shadow border p-6">
          ...
          <div className="space-y-4">
            {mockAuditData
              ...
              .slice(0, 5)
              .map(audit => (
                <div key={`major-${audit.id}`} className="p-3 bg-red-50 border border-red-200 rounded">
        ...
        <div className="bg-white rounded-lg shadow border p-6">
          ...
          <div className="space-y-4">
            <div className="p-3 bg-green-50 border border-green-200 rounded">
              ...
              <p className="text-sm text-gray-600 mt-1">Coincidencia entre fuentes locales y externas</p>
            </div>
            
            <div className="p-3 bg-blue-50 border border-blue-200 rounded">
              <div className="flex justify-between">
                <span className="font-medium">Actualización de Datos</span>
                <span className="font-semibold text-blue-600">2025-09-25</span>
              </div>
              <p className="text-sm text-gray-600 mt-1">Última sincronización con datos oficiales</p>
            </div>
            ...
            <div className="p-3 bg-yellow-50 border border-yellow-200 rounded">
              ...
              <p className="text-sm text-gray-600 mt-1">Fuente oficial de datos para validación</p>
            </div>
          </div>
        </div>
      </div>
