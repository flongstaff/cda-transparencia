...
import { Search, Filter, Download, Calendar, FileText, BarChart3, Eye, DollarSign, Coins, CreditCard, AlertTriangle, PiggyBank, Scale } from 'lucide-react';
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            ...
            <ValidatedChart
              data={categoryData.financial_data.category_breakdown.map(item => ({
                name: item.name,
                value: Math.round(item.budgeted / 1000000)
              }))}
              chartType="budget"
              year={selectedYear}
            ...
            {categoryData.documents.slice(0, 5).map((doc) => (
              <div key={doc.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" title="Ver documento">
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    <button className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700" title="Ver documento">
                      <Eye className="h-4 w-4" />
                    </button>
                    <a 
                      href={doc.url} 
